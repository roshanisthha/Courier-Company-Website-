...
<section class="booking p-5 " style="padding-top: 10%;">

   <h3 class="heading-title trainingplan" style="padding-top: 5%;">BOOK YOUR SHIPPING!</h3>
   ...
   <form action="action.php" method="post" class="book-form">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" placeholder="write weight of product" name="people">
         </div>
         <div class="inputBox">
            <span>arrivals :</span>
